...
public class ExportFileConstants {

	/**
	 * Collection Progress
	 */
	public static final String COLLECTION_OVERVIEW = "Collection Overview";
	public static final String VIEWS = "Views";
	public static final String TOTAL_TIME_SPENT = "Total Time Spent";
	public static final String AVG_REACTION = "Avg Reaction";
